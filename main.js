...
info.onAdd = function (map) {
  ...
  this._div.innerHTML = '<a href="https://map.cs.dartmouth.edu/git-map/"><h4>CS Map</h4></a><p><a href="https://github.com/dartmouth-cs52/git-map">code on github</p></a><div id="error"></div>';
  return this._div;
};
